        ...
        <div class="relative isolate overflow-hidden bg-gray-900">
            <div class="px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
                <div class="mx-auto max-w-2xl text-center">
                    {{-- Gunakan data dari settings, dengan fallback ke teks asli --}}
                    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">{{ $settings['hero_title'] ?? 'Portofolio Karya Siswa' }}</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-300">{{ $settings['hero_subtitle'] ?? 'Menampilkan talenta dan inovasi dari siswa-siswi berprestasi SMK-IT As-Syifa Boarding School.' }}</p>
                ...
                <div class="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    @foreach ($featuredProjects as $project)
                        <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80 group">
                            <img src="{{ $project->media->firstWhere('file_type', 'image') ? $project->media->firstWhere('file_type', 'image')->file_url : 'https://placehold.co/600x400/004D40/FFFFFF?text=Project' }}" alt="Gambar Proyek" class="absolute inset-0 -z-10 h-full w-full object-cover transition-transform duration-300 ease-in-out group-hover:scale-105">
        ...
        <div class="bg-gray-100 dark:bg-gray-900 py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 text-center sm:text-left">
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Karya Terbaru</h2>
                    <p class="mt-2 text-lg leading-8 text-gray-600 dark:text-gray-400">Lihat karya-karya terbaru yang baru saja dipublikasikan oleh siswa.</p>
                </div>
                <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 dark:border-gray-700 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
